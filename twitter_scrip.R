# twitteR scrip #
rm(list = ls())
if(!requireNamespace("base64enc")) install.packages("base64enc")
if(!requireNamespace("RCurl")) install.packages("RCurl")
if(!requireNamespace("ROAuth")) install.packages("ROAuth")
if(!requireNamespace("twitteR")) install.packages("twitteR")
library("base64enc")
library("twitteR")
library("ROAuth")
library("RCurl")
